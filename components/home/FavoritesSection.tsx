                ...
                {favorites.map((fav) => (
                    <button
                        ...
                        className={`flex-shrink-0 px-4 py-2.5 rounded-xl border transition-all ${selectedCity?.name === fav.name
                                ? "bg-primary-500/15 border-primary-500/60 text-primary-300 shadow-lg shadow-primary-500/10"
                                : "bg-slate-900/40 border-slate-700/50 text-slate-300 hover:border-slate-600 hover:bg-slate-800/40"
                            }`}
                    >
